...
public class SharePrefsMain {
    ...
    public static final String PROFILE_DATA = "myProfileResponse";
    ...
    private static SharePrefsMain instance;


    public SharePrefsMain(Context context) {
        ctx = context;
        sharedPreferences = context.getSharedPreferences(PREFERENCE, 0);
    }

    public static SharePrefsMain getInstance(Context ctx) {
        if (instance == null) {
            instance = new SharePrefsMain(ctx);
        }
        return instance;
    }
