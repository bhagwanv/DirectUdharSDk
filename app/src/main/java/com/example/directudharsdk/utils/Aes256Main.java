...
public class Aes256Main {
    ...
    public static String encrypt(String text, String password) throws Exception {
        ...
        return Base64Main.encodeToString(data, Base64Main.DEFAULT);
    }
    ...
    public static String decrypt(String encrypted, String password) throws Exception {
        ...
        final byte[] inBytes = Base64Main.decode(encrypted, Base64Main.DEFAULT);
    ...
    public static void main(String[] args) throws Exception {
        String encrypted = Aes256Main.encrypt("TEXT", "PASSWORD");

        Log.d("encrypted",encrypted);

        String decrypted = Aes256Main.decrypt(encrypted, "PASSWORD");
