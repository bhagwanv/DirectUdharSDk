...
class ApprovalPendingViewModel @Inject constructor(private val repository: ApprovalPendingRepository) :
    ...
    private val approvalPendingResult = SingleLiveEvent<String>()

    private var _displayDisbursalAmountResponse = SingleLiveEvent<NetworkResult<DisplayDisbursalAmountResponse>>()
    val displayDisbursalAmountResponse: LiveData<NetworkResult<DisplayDisbursalAmountResponse>> = _displayDisbursalAmountResponse

    private var _updateLeadSuccessResponse = SingleLiveEvent<NetworkResult<InitiateAccountModel>>()
