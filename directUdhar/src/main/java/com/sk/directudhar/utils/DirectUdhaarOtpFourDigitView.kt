...
class DirectUdhaarOtpFourDigitView(context: Context, attrs: AttributeSet?) : LinearLayout(context, attrs) {

    private var otpDigits: Array<EditText?> = arrayOfNulls(4)

    init {
        inflate(context, R.layout.direct_udhaar_otp_four_digit_view, this)
        setupViews()
    }
